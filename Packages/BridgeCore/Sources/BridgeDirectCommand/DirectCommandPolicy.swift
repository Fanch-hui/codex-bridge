...
public struct DirectCommandPolicy: Sendable {
  ...
  public static let defaultSafeRules: [DirectSafeCommandRule] = [
    ...
    DirectSafeCommandRule(executable: "git", argumentsPrefix: ["branch", "--show-current"]),
    DirectSafeCommandRule(
      executable: "/usr/bin/git", argumentsPrefix: ["branch", "--show-current"]),
    ...
    DirectSafeCommandRule(executable: "git", argumentsPrefix: ["branch", "--list"]),
    DirectSafeCommandRule(executable: "/usr/bin/git", argumentsPrefix: ["branch", "--list"]),
    DirectSafeCommandRule(executable: "git", argumentsPrefix: ["tag", "--list"]),
    DirectSafeCommandRule(executable: "/usr/bin/git", argumentsPrefix: ["tag", "--list"]),
    DirectSafeCommandRule(executable: "git", argumentsPrefix: ["describe"]),
    DirectSafeCommandRule(executable: "/usr/bin/git", argumentsPrefix: ["describe"]),
    DirectSafeCommandRule(executable: "node", argumentsPrefix: ["--check"]),
    ...
    DirectSafeCommandRule(executable: "swift", argumentsPrefix: ["--version"]),
    DirectSafeCommandRule(executable: "/usr/bin/swift", argumentsPrefix: ["--version"]),
    DirectSafeCommandRule(executable: "xcodebuild", argumentsPrefix: ["-version"]),
    DirectSafeCommandRule(executable: "/usr/bin/xcodebuild", argumentsPrefix: ["-version"]),
