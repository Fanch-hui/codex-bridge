...
func newThreadProgressScript(root: String) -> String {
  ...
  return executionCommonHandshake()
    + "\n"
      ...
      printf '%s\n' '{"method":"item/started","params":{"threadId":"thread-progress","turnId":"turn-progress","startedAtMs":2,"item":{"id":"item-command","type":"commandExecution","command":"swift test","commandActions":[{"type":"read","command":"sed -n 1,120p Sources/App.swift","name":"Sources/App.swift","path":"__ROOT__/Sources/App.swift"}],"cwd":"__ROOT__","status":"inProgress"}}}'
