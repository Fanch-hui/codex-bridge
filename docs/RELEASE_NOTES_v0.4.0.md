...
- 新增详细使用指南、DeepSeek Harness 接入指南和 Antigravity / AGY 权限配置说明。
...
- Apple Silicon Mac：下载 `CodexBridge-0.4.0-macos-arm64.dmg` 或 `.zip`。
- Intel Mac：下载 `CodexBridge-0.4.0-macos-x86_64.dmg` 或 `.zip`。
- `SBOM.spdx.json`
- `SHA256SUMS`
